...
app.UseSecurityHeaders(policies => policies
    ...
    .AddContentSecurityPolicy(csp =>
    {
        ...
        csp.AddStyleSrc().Self().UnsafeInline().From("https://fonts.googleapis.com");  // MudBlazor + Google Fonts
...
static MapaDetalheResponse ToDetalheResponse(Numerologia.Core.Entities.MapaNumerologico m) =>
    new(m.Id, m.NomeUtilizado, m.DataNascimento, m.CriadoEm,
        ...
        m.SomaMotivacao, m.SomaImpressao, m.SomaExpressao,
...
record MapaDetalheResponse(
    ...
    int SomaMotivacao, int SomaImpressao, int SomaExpressao,
